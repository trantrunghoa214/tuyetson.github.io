  ...
  songs: [
    {
      name: '3170',
      singer: 'nau x duong',
      path: './listmusic/music/song1.mp3',
      image: './listmusic/img/anh1.jpg',
    },
    {
      name: ' nhạt ',
      singer: 'Phan Mạnh Quỳnh',
      path: './listmusic/music/song2.mp3',
      image: './listmusic/img/anh2.jpg',
    },
    {
      name: 'Vợ Người Ta',
      singer: 'Phan Mạnh Quỳnh',
      path: './listmusic/music/song3.mp3',
      image: './listmusic/img/anh3.jpg',
    },
    {
      name: 'muộn rồi mà sao còn',
      singer: 'Sơn Tùng M-TP',
      path: './listmusic/music/song4.mp3',
      image: './listmusic/img/anh4.jpg',
    },
    {
      name: 'Gét em làm bạn anh',
      singer: 'Phan mạnh Quỳnh',
      path: './listmusic/music/song5.mp3',
      image: './listmusic/img/anh5.jpg',
    },
